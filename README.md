...
2. Create `.env` file and insert your W&B API key:
    ...
    ```
# Training 
Configuration is saved under path `configs/evaluate.yaml`. Adjust and run the scripts. Examples: 
...
```
# Testing 
Configuration is saved under path `configs/evaluate.yaml`. Run the scripts with test data information passed as arguments. Examples: 
